...
const GameDetailPage = () => {
    ...
    useEffect(() => {
        const fetchGameDetail = async () => {
            try {
                const res = await fetch(`https://hungnt.backendintern.online/api/game/${id}`, {
                    method: 'GET',
                    credentials: 'include',
                });
    ...
    useEffect(() => {
        const fetchGameSimilarGenres = async () => {
            try {
                setLoading(true);
                const res = await fetch(`https://hungnt.backendintern.online/api/game/similar/${id}`, {
                    method: 'GET',
                    credentials: 'include',
                });
                const data = await res.json();
    ...
    useEffect(() => {
        const fetchAverageRating = async (gameId) => {
            try {
                const response = await axios.get(`https://hungnt.backendintern.online/api/rating/${gameId}`);
                if (response.data.success) {
    ...
    const submitRating = async (GameID, UserID, ratingValue) => {
        ...
        try {
            const response = await fetch('https://hungnt.backendintern.online/api/rating', {
                method: 'POST',
